...
city = Label(root, text="", bg="#F0F0F0", font=("Courier", 20))
description = Label(root, text="", bg="#F0F0F0", font=("Courier", 20))
first_icon = get_new_icon("https://openweathermap.org/img/wn/01d@2x.png")
weather_icon = Label(root, image=first_icon, bg="#F0F0F0")
temp = Label(root, text="", bg="#F0F0F0", font=("Courier", 20))
humidity = Label(root, text="", bg="#F0F0F0", font=("Courier", 20))
windsp = Label(root, text="", bg="#F0F0F0", font=("Courier", 20))
sunrise = Label(root, text="", bg="#F0F0F0", font=("Courier", 20))
sunset = Label(root, text="", bg="#F0F0F0", font=("Courier", 20))
